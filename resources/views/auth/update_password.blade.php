            ...
            <div class="  row py-5 mt-4">
              ...
              <div class="col-lg-6 surpluslogin-right">
                <form action="{{ route('password.reset.submit') }}" method="POST">
                    ...
                    <h1 class="signup-form_heading mb-3">New Password</h1>
                    ...
                    <input type="password" name="password" class="form-control surplus-login-input mb-3 p-3" placeholder="Enter New Password" required>
                    @error('password')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    
                    <input type="password" name="password_confirmation" class="form-control surplus-login-input mb-3 p-3" placeholder="Confirm New Password" required>
                    @error('password_confirmation')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    
                    <button type="submit" class="btn surplus-login-btn w-100 p-2 mb-3">Reset Password</button>
